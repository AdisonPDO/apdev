export const stepsData = [
  {
    number: "1",
    title: "Analyse",
    text: "Une étude approfondie des objectifs, de l’audience cible et de l’activité permet de poser les bases solides pour un projet sur mesure, qu’il s’agisse d’un site web, d’une application mobile ou d’une stratégie SEO.",
  },
  {
    number: "2",
    title: "Conception",
    text: "Un design clair, moderne et adapté à l’image de marque est élaboré. Chaque interface est pensée pour offrir une expérience utilisateur optimale, avec une attention particulière à l’ergonomie et à l’esthétique.",
  },
  {
    number: "3",
    title: "Développement",
    text: "Les idées prennent vie grâce à des technologies performantes. Que ce soit un site web rapide, une application mobile intuitive ou des fonctionnalités avancées, le développement est réalisé avec rigueur et qualité.",
  },
  {
    number: "4",
    title: "Lancement",
    text: "Après le lancement, des services de maintenance, des mises à jour et des optimisations SEO assurent une visibilité maximale en ligne.",
  },
];
