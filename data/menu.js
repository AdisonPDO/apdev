...
export const boldMultipage = [
  { href: "/", text: "Accueil", active: false },
  { href: "/about", text: "À propos", active: true },
  { href: "/services", text: "Services", active: false },
  { href: "/projects", text: "Projets", active: false },
  { href: "/contact", text: "Contact", active: false },
];
export const boldMultipageDark = [
  { href: "/bold-multi-page-dark", text: "Accueil", active: false },
  { href: "/bold-about-dark", text: "À propos", active: true },
  { href: "/bold-services-dark", text: "Services", active: false },
  { href: "/bold-portfolio-dark", text: "Projets", active: false },
  { href: "/bold-contact-dark", text: "Contact", active: false },
];

export const boldOnepage = [
  { href: "#home", text: "Accueil", className: "active" },
  { href: "#about", text: "À propos" },
  { href: "#services", text: "Services" },
  { href: "#portfolio", text: "Projets" },
  {/* href: "#blog", text: "Blog" */},
  { href: "#contact", text: "Contact" },
];
